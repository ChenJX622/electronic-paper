...
gpt_instance_ctrl_t g_gpt0_ctrl;
#if 0
const gpt_extended_pwm_cfg_t g_gpt0_pwm_extend =
{
...
#endif
const gpt_extended_cfg_t g_gpt0_extend =
{
...
const timer_cfg_t g_gpt0_cfg =
{
    .mode                = TIMER_MODE_PERIODIC,
    /* Actual period: 0.0000625 seconds. Actual duty: 50%. */ .period_counts = (uint32_t) 0x186a, .duty_cycle_counts = 0xc35, .source_div = (timer_source_div_t)0,
    .channel             = 0,
